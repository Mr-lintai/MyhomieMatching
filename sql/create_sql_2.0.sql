create database if not exists homie;

use homie;

/*用户表*/
create table homie.user
(
...
FROM homie.user_team ut
         JOIN homie.team t ON ut.teamId = t.id
...
select a.*,b.* from homie.team a, homie.user_team b where a.id = b.teamId;

alter table homie.blog auto_increment = 8;
